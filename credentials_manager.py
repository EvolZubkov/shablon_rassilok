...
def validate_credentials_data(data: dict) -> tuple[bool, str | None]:
    """
...
def save_credentials(path: str, server: str, username: str, password: str,
                     from_email: str, default_senders: list = None,
...
def load_credentials(path: str, hostname: str = None) -> dict | None:
    """
